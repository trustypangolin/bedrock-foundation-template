...
output "secure_subnet_ids" {
  value = length(module.modules_vpc) > 0 ? module.modules_vpc.secure_subnet_ids : null
}

output "secure_subnet_cidrs" {
  value = length(module.modules_vpc) > 0 ? module.modules_vpc.secure_subnet_cidrs : null
}
...
output "secure_rt_ids" {
  value = length(module.modules_vpc) > 0 ? module.modules_vpc.secure_rt_ids : null
}